...
static char *font2[] = {"Symbola:size=14:antialias=true:autohint=true"};
...
static const ColorScheme schemes[] = {
	...
	{{"black", "red3", "green3", "yellow3",
	  "#0d73cc", "magenta3", "cyan3", "gray90",
	  "gray50", "red", "green", "yellow",
	  "#1a8fff", "magenta", "cyan", "white",
	  [256]="#cccccc", "#555555"}, 7, 0, 256, 257},

	// Tokyo Night (night)
	{{"black", "#f7768e", "#9ece6a", "#e0af68",
...
static Shortcut shortcuts[] = {
	...
	{ MODKEY,               XK_0,           selectscheme,   {.i =  0} },
	{ MODKEY,               XK_1,           selectscheme,   {.i =  1} },
	{ MODKEY,               XK_2,           selectscheme,   {.i =  2} },
	{ MODKEY,               XK_3,           selectscheme,   {.i =  3} },
	{ MODKEY,               XK_8,           nextscheme,     {.i = +1} },
	{ MODKEY,               XK_5,           nextscheme,     {.i = -1} },
